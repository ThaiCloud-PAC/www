...
/** lucide dropped brand marks, so LinkedIn is inlined (Simple Icons, CC0). */
export default function SocialIcon({ glyph, className = "size-4" }: { glyph: "linkedin" | "mail"; className?: string }) {
  if (glyph === "mail") return <Mail className={className} aria-hidden="true" />;
  return (
